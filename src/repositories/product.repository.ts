...
export class ProductRepository {
  async create(storeId: string, data: { name: string; description?: string | null; image?: string | null; price: number; available: boolean }): Promise<Product> {
  ...
  async update(storeId: string, id: string, data: Partial<{ name: string; description?: string | null; image?: string | null; price: number; available: boolean }>): Promise<Product> {
